...
const RankSystem = {
    ranks: [
        ...
        { name: 'Silver III', icon: '🥈', min: 1000, max: 1199, color: '#C0C0C0' },
        { name: 'Silver II', icon: '🥈', min: 1200, max: 1399, color: '#C0C0C0' },
        { name: 'Silver I', icon: '🥈', min: 1400, max: 1499, color: '#C0C0C0' },
        
        { name: 'Gold III', icon: '🥇', min: 1500, max: 1699, color: '#FFD700' },
        { name: 'Gold II', icon: '🥇', min: 1700, max: 1899, color: '#FFD700' },
        { name: 'Gold I', icon: '🥇', min: 1900, max: 1999, color: '#FFD700' },
        
        { name: 'Platinum III', icon: '💎', min: 2000, max: 2199, color: '#E5E4E2' },
        { name: 'Platinum II', icon: '💎', min: 2200, max: 2399, color: '#E5E4E2' },
        { name: 'Platinum I', icon: '💎', min: 2400, max: 2499, color: '#E5E4E2' },
        
        { name: 'Diamond III', icon: '💠', min: 2500, max: 2699, color: '#B9F2FF' },
        { name: 'Diamond II', icon: '💠', min: 2700, max: 2899, color: '#B9F2FF' },
        { name: 'Diamond I', icon: '💠', min: 2900, max: 2999, color: '#B9F2FF' },
        
        { name: 'Master', icon: '👑', min: 3000, max: 3499, color: '#9370DB' },
        { name: 'Legend', icon: '⚡', min: 3500, max: Infinity, color: '#FF1493' }
    ],
    ...
    getRankTier(rankName) {
        ...
        if (rankName.includes('Legend')) return 'legend';
        return 'bronze';
    }
};
